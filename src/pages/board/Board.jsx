...
//       try {
//         const response = await instance.get(
//           `/postCards?maincategory=유머&category=${category}&splitNumber=4&splitPageNumber=${page}`
//         );
//         console.log("data------->", response.data.postCards);
//         setHumour((prevHumour) => [...prevHumour, ...response.data.postCards]);
//       } catch (error) {
//         console.error(error);
//       }
//     };
