...
<p align="center"><img style="border-radius: 10px; box-shadow: rgba(100, 100, 111, 0.2) 0px 7px 29px 0px;" src=https://github.com/eh-lee/team8Project/assets/121739975/856640f0-4d42-4bc6-b8e8-9680421734e4>

</br>

> **프로젝트 소개**

- '훈수'는 자유롭게 서로에게 훈수를 두는, AI 참여형 소셜네트워크 서비스입니다.
...
- 구글 라이트하우스를 활용한 성능 개선
- 번들링 최적화를 위한 라이브러리 경량화
- 가독성과 유지보수성 제고를 위한 컴포넌트 정리
